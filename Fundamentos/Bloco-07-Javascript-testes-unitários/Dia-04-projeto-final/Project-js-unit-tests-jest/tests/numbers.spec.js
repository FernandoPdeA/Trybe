...
describe('2 - Implemente os casos de teste para a função `numbers`', () => {
  ...
  it('Recebe apenas números, então retorna true', () => {
    expect(numbers([1, 2, 3, 4, 5])).toBeTruthy();
  });

  it('Não são todos números, então retorna false', () => {
    expect(numbers([1, 2, '3', 4, 5])).toBeFalsy();
  });

  it('Não são apenas números, então retorna false', () => {
    expect(numbers([1, 'a', 3])).toBeFalsy();
  });

  it('Array vazio, então retorna false', () => {
